  ...
  stages {
    ...
    stage ('Paso 5: Despliegue') {
      ...
      steps {
        ...
        sshPublisher(publishers: [sshPublisherDesc(configName: 'Deployproduccion', transfers: [sshTransfer(cleanRemote: false, excludes: '**/*', execCommand: 'echo "preparando copia de seguridad" && var1=date +%d%m%Y_%H%M%S; mkdir /home/backup_app/$var1 ; cp -r /home/saleor-produccion/dist  /home/backup_app/$var1 & echo "copia de seguridad terminada" && echo "preparando despliegue de archivos', execTimeout: 120000, flatten: false, makeEmptyDirs: false, noDefaultExcludes: false, patternSeparator: '[, ]+', remoteDirectory: '', remoteDirectorySDF: false, removePrefix: '', sourceFiles: ''), sshTransfer(cleanRemote: false, excludes: '', execCommand: 'echo "despliegue de archivos terminado"', execTimeout: 120000, flatten: false, makeEmptyDirs: false, noDefaultExcludes: false, patternSeparator: '[, ]+', remoteDirectory: '', remoteDirectorySDF: false, removePrefix: '', sourceFiles: '**/*')], usePromotionTimestamp: false, useWorkspaceInPromotion: false, verbose: false)])
